...
public class MyTravelOrderAdapter extends SGTHolderDefAdapter<JSONObject> {

	public MyTravelOrderAdapter(Context context, List<JSONObject> list, Object... objects) {
	...
	protected BaseViewHolder<JSONObject> getHolderView(View layout) {
		...
		return new MyTravelOrderViewHolder(layout);
	}

	@Override
	protected int getLayoutRes() {
		// TODO Auto-generated method stub
		return R.layout.my_travel_order_item_layout;
	}

	class MyTravelOrderViewHolder extends DefHolderView<JSONObject> {
		...
		public MyTravelOrderViewHolder(View layout) {
			super(layout);
		}
