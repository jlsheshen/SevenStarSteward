 ...
 * 社区活动内容详情界面
 */
public class CommunityActivityContentActivity extends BannerBaseActivity {
...
//	RelativeLayout headLayout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setBaseContextView(R.layout.activity_community_activity_content_page);
		setColumnText("社区活动");
		x.view().inject(this);
		initData();
	}
	...
	private void initData() {
		...
		if (bundle != null) {
			...
			//	ViewUtils.setTextData(threeTV, jsonObj.getString("ComminityName"));
				...
				ViewUtils.setTextData(fiveTV, jsonObj.getString("HoldName"));
				ViewUtils.setTextData(sixTV, jsonObj.getString("HoldTel"));
			//	ViewUtils.setTextData(eightTV, jsonObj.getString("Content"));
