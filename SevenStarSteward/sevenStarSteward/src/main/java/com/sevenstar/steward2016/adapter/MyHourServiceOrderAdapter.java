...
public class MyHourServiceOrderAdapter extends SGTHolderDefAdapter<JSONObject> {

	public MyHourServiceOrderAdapter(Context context, List<JSONObject> list, Object... objects) {
